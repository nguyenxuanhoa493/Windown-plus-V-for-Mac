...
**🎉 Tính năng mới:**
-   **Tab "Tính năng" trong Cài đặt**: Thêm tab riêng để bật/tắt từng tính năng theo nhu cầu
    - Đưa mục lên đầu sau khi dán
    - Chuyển JSON sang dạng bảng
    - Chuyển JSON sang Excel (.xlsx)
    - Chuyển dạng bảng sang JSON
    - Mở URL trong trình duyệt
    - Chuyển đổi timestamp ↔ datetime
    - Tìm kiếm theo từ khóa
    - Kéo thả file
-   **Cài đặt được tổ chức thành Tabs**: Tách thành 2 tab "Chung" (ngôn ngữ, giao diện, phím tắt, lịch sử, cập nhật) và "Tính năng"

**✨ Cải tiến:**
-   **Vị trí cửa sổ thông minh**: Cửa sổ lịch sử luôn xuất hiện ngay bên dưới-phải con trỏ, tự động kẹp trong màn hình khi con trỏ ở gần cạnh phải/dưới (hỗ trợ multi-monitor)
...
1. **Tải xuống**: Download file `Clipboard-3.2.dmg` từ [trang Releases](https://github.com/nguyenxuanhoa493/Windows-plus-V-for-Mac/releases)
