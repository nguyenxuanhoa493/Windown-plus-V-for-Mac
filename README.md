...
-   **Văn bản**: Lưu trữ và quản lý text đã copy, giữ nguyên format (RTF, HTML)
...
1. **Tải xuống**: Download file `Clipboard-2.9.dmg` từ [trang Releases](https://github.com/nguyenxuanhoa493/Windown-plus-V-for-Mac/releases)
